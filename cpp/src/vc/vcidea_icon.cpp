...
// VCIdeaIcon.cpp - byte-direct Read (slot 12) decoder; thunks to the shared
// Icon-family reader. Body identical for all 5 Icon family classes.

#include "vc/vcidea_icon.h"
...
void VCIdeaIcon::Write(hdb::HDBContext* ctx) const {
    if (ctx == nullptr) return;
