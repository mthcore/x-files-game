...
// VCNavList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCNAVLIST_H
#define VC_VCNAVLIST_H
...
class VCNavList : public VCObject {
public:
    VCNavList() noexcept;
    ~VCNavList() override;
...
XFILES_ASSERT_SIZE(VCNavList, VCNAV_LIST_SIZE, "VCNavList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCNavList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCNavList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCNAVLIST_H
