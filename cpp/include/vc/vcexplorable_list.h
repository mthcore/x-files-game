...
// VCExplorableList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCEXPLORABLELIST_H
#define VC_VCEXPLORABLELIST_H
...
class VCExplorableList : public VCObject {
public:
    VCExplorableList() noexcept;
    ~VCExplorableList() override;
...
XFILES_ASSERT_SIZE(VCExplorableList, VCEXPLORABLELIST_SIZE, "VCExplorableList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCExplorableList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCExplorableList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCEXPLORABLELIST_H
