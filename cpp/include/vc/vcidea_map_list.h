...
// VCIdeaMapList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCIDEAMAPLIST_H
#define VC_VCIDEAMAPLIST_H
...
class VCIdeaMapList : public VCObject {
public:
    VCIdeaMapList() noexcept;
    ~VCIdeaMapList() override;
...
XFILES_ASSERT_SIZE(VCIdeaMapList, VCIDEAMAPLIST_SIZE, "VCIdeaMapList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCIdeaMapList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCIdeaMapList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCIDEAMAPLIST_H
