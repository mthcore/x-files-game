...
// VCStdAction - byte-direct Read (slot 12) decoder.

#ifndef VC_VCSTDACTION_H
#define VC_VCSTDACTION_H
...
public:
    VCStdAction() noexcept;
    ~VCStdAction() override;
    ...
    uint32_t cache_h;  // +0x30 tag h (g skipped)

};

XFILES_ASSERT_SIZE(VCStdAction, VCSTDACTION_SIZE, "VCStdAction size 0x34");
XFILES_ASSERT_OFFSET(VCStdAction, cache_e, 0x28, "cache_e");
XFILES_ASSERT_OFFSET(VCStdAction, cache_h, 0x30, "cache_h");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCSTDACTION_H
