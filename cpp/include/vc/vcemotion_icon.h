...
// VCEmotionIcon - 68-byte Icon (member of the 5-class Icon family, vc_family_icon.md).
//
...
#ifndef VC_VCEMOTIONICON_H
#define VC_VCEMOTIONICON_H
...
public:
    VCEmotionIcon() noexcept;
    ~VCEmotionIcon() override;
...
XFILES_ASSERT_SIZE(VCEmotionIcon, VCEMOTIONICON_SIZE, "VCEmotionIcon size 0x44 mismatch");
XFILES_ASSERT_OFFSET(VCEmotionIcon, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCEmotionIcon, cache_e, 0x28, "cache_e offset");
XFILES_ASSERT_OFFSET(VCEmotionIcon, cache_f, 0x2C, "cache_f offset");
XFILES_ASSERT_OFFSET(VCEmotionIcon, cache_g, 0x30, "cache_g offset");
XFILES_ASSERT_OFFSET(VCEmotionIcon, cache_h, 0x34, "cache_h offset");
XFILES_ASSERT_OFFSET(VCEmotionIcon, cache_k, 0x38, "cache_k offset");
XFILES_ASSERT_OFFSET(VCEmotionIcon, cache_i, 0x3C, "cache_i offset");
XFILES_ASSERT_OFFSET(VCEmotionIcon, cache_j, 0x40, "cache_j offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCEMOTIONICON_H
