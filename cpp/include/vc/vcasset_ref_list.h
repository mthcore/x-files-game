...
// VCAssetRefList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCASSETREFLIST_H
#define VC_VCASSETREFLIST_H
...
class VCAssetRefList : public VCObject {
public:
    VCAssetRefList() noexcept;
    ~VCAssetRefList() override;
...
XFILES_ASSERT_SIZE(VCAssetRefList, VCASSETREFLIST_SIZE, "VCAssetRefList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCAssetRefList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCAssetRefList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCASSETREFLIST_H
