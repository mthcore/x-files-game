...
// VCTriggerList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCTRIGGERLIST_H
#define VC_VCTRIGGERLIST_H
...
class VCTriggerList : public VCObject {
public:
    VCTriggerList() noexcept;
    ~VCTriggerList() override;
...
XFILES_ASSERT_SIZE(VCTriggerList, VCTRIGGERLIST_SIZE, "VCTriggerList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCTriggerList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCTriggerList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCTRIGGERLIST_H
