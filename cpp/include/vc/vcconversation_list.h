...
// VCConversationList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCCONVERSATIONLIST_H
#define VC_VCCONVERSATIONLIST_H
...
class VCConversationList : public VCObject {
public:
    VCConversationList() noexcept;
    ~VCConversationList() override;
...
XFILES_ASSERT_SIZE(VCConversationList, VCCONVERSATIONLIST_SIZE, "VCConversationList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCConversationList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCConversationList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCCONVERSATIONLIST_H
