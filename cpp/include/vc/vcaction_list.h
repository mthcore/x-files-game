...
// VCActionList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCACTIONLIST_H
#define VC_VCACTIONLIST_H
...
public:
    VCActionList() noexcept;
    ~VCActionList() override;
...
XFILES_ASSERT_SIZE(VCActionList, VCACTIONLIST_SIZE, "VCActionList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCActionList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCActionList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCACTIONLIST_H
