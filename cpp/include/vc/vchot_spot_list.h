...
// VCHotSpotList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCHOTSPOTLIST_H
#define VC_VCHOTSPOTLIST_H
...
class VCHotSpotList : public VCObject {
public:
    VCHotSpotList() noexcept;
    ~VCHotSpotList() override;
...
XFILES_ASSERT_SIZE(VCHotSpotList, VCHOTSPOTLIST_SIZE, "VCHotSpotList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCHotSpotList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCHotSpotList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCHOTSPOTLIST_H
