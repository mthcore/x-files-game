...
// VCCharViewList � 100-byte List<T> container (member of the 10-class List family).
//
...
#ifndef VC_VCCHARVIEWLIST_H
#define VC_VCCHARVIEWLIST_H
...
class VCCharViewList : public VCObject {
public:
    VCCharViewList() noexcept;
    ~VCCharViewList() override;
...
XFILES_ASSERT_SIZE(VCCharViewList, VCCHARVIEWLIST_SIZE, "VCCharViewList size 0x64 mismatch");
XFILES_ASSERT_OFFSET(VCCharViewList, _base_scratch, 0x04, "_base_scratch offset");
XFILES_ASSERT_OFFSET(VCCharViewList, sub_coll, 0x28, "sub_coll offset");

}  // namespace vc
}  // namespace xfiles

#endif  // VC_VCCHARVIEWLIST_H
